<x-filament-panels::page>
    ...
    <div class="flex gap-8 w-full">
        <div class="bg-blue-100 dark:bg-gray-800 p-6 rounded-xl w-full">
            <div class="text-lg mb-3">Hutang Belum Terbayar</div>
            <div class="flex justify-between items-center">
                <div class="text-left">
                    <div class="text-2xl font-bold text-blue-700 dark:text-blue-300">{{ $accountPayables }}</div>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="size-10 text-blue-500 dark:text-blue-300 fill-current">>
        ...
        <div class="bg-blue-100 dark:bg-gray-800 p-6 rounded-xl w-full">
            <div class="text-lg mb-3">Piutang Jatuh Tempo</div>
            <div class="flex justify-between items-center">
                <div class="text-left">
                    <div class="text-2xl font-bold text-blue-700 dark:text-blue-300">{{ $totalReceivables }}</div>
                </div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        class="size-10 text-blue-500 dark:text-blue-300 fill-current">>
    ...
    <!-- Filament Tables Section -->
    <div class="grid grid-cols-2 gap-8 mt-8">
        <div>
            @livewire(\App\Filament\Pages\FinanceSummary\Widgets\LatestSalesTable::class)
        </div>
        <div>
            @livewire(\App\Filament\Pages\FinanceSummary\Widgets\TopCustomersTable::class)
        </div>
    </div>
